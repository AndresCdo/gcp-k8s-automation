...
ssh -i ~/.ssh/kubernetes-lab-ssh-key -o 'StrictHostKeyChecking no' andres@$master_node "ansible-playbook -i inventory.ini --private-key ~/.ssh/kubernetes-lab-ssh-key --ssh-extra-args '-o '"'StrictHostKeyChecking no'"'' -u andres playbook.yml"
